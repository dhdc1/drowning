...
/**
 * PopulationTargetSearch represents the model behind the search form of `app\modules\pop\models\PopulationTarget`.
 */
class PopulationTargetSearch extends PopulationTarget {
